"""
Django settings for young_boat_dev_57508 project.
...
ROOT_URLCONF = 'young_boat_dev_57508.urls'
...
WSGI_APPLICATION = 'young_boat_dev_57508.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "young_boat_dev_57508 API",
    "DESCRIPTION": "API documentation for young_boat_dev_57508 App",
    "VERSION": "v1",
}
